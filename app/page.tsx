...
export default function LandingPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#0a0a0a] selection:bg-indigo-500/30 overflow-x-hidden text-zinc-100">
      ...
      <nav className="relative z-20 pt-6">
        <div className="mx-auto w-max rounded-full border border-white/10 bg-zinc-950/80 backdrop-blur-2xl px-4 sm:px-6 py-2.5 flex items-center gap-6 shadow-[0_8px_32px_rgba(0,0,0,0.4)]">
          <Link href="/" className="flex items-center gap-2 text-lg font-bold text-zinc-100 mr-2">
          ...
          <div className="hidden md:flex items-center gap-5 text-sm">
            ...
            <Link href="#testimonials" className="text-zinc-400 hover:text-zinc-100 transition-colors">
              {t("nav.testimonials")}
            </Link>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
            ...
            >
              ...
              <p className="text-base sm:text-lg text-zinc-400 max-w-[65ch] leading-relaxed mb-10">
                {t("hero.subtitle")}
              </p>
              ...
              <div className="flex flex-col sm:flex-row items-start gap-4">
                ...
                <Link
                  href="/login"
                  className="inline-flex items-center gap-2 text-zinc-400 hover:text-zinc-100 px-7 py-3.5 rounded-full font-medium text-base border border-zinc-800 hover:border-zinc-700 transition-all"
                >
                  {t("buttons.liveDemo")}
            ...
            <motion.div
              ...
              className="relative"
            >
              <div className="relative rounded-2xl border border-white/10 bg-zinc-900/60 backdrop-blur-xl p-2 shadow-[0_20px_60px_rgba(0,0,0,0.5)]">
                <div className="rounded-xl border border-white/5 bg-zinc-950/80 overflow-hidden">
                  <div className="flex items-center gap-1.5 px-4 py-3 border-b border-white/5">
                    <div className="h-2.5 w-2.5 rounded-full bg-rose-500/70" />
                    <div className="h-2.5 w-2.5 rounded-full bg-amber-500/70" />
                    <div className="h-2.5 w-2.5 rounded-full bg-emerald-500/70" />
                    <span className="ml-2 text-[10px] text-zinc-600 font-mono">SalesPulse Dashboard</span>
                  </div>
                  <div className="aspect-[4/3] relative overflow-hidden bg-gradient-to-br from-zinc-900 via-zinc-900 to-zinc-950 flex items-center justify-center">
                    ...
                    <div className="relative z-10 w-full p-6">
                      ...
                      <div className="grid grid-cols-3 gap-3">
                        {[
                          ...
                          <div key={kpi.label} className="bg-zinc-900/80 rounded-lg border border-zinc-800 p-2.5">
                            <div className="text-[10px] text-zinc-500">{kpi.label}</div>
                            <div className="text-sm font-bold text-zinc-100">{kpi.value}</div>
                          </div>
                        ))}
                      </div>
                    </div>
      ...
      <FadeInUp>
        <section className="relative z-10 py-16 border-y border-white/5">
          <div className="max-w-7xl mx-auto px-6 text-center">
            <p className="text-xs uppercase tracking-[0.15em] text-zinc-500 font-medium mb-8">
              {t("trustedBy")}
            </p>
              ...
              {stats.map((stat, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-3xl md:text-4xl font-bold text-zinc-100 mb-1">{stat.value}</div>
                    <div className="text-sm text-zinc-500">{t(`stats.${stat.key}`)}</div>
                  </motion.div>
                );
              })}
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <FadeInUp>
            <div className="text-center mb-16">
              <span className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-zinc-800/50 border border-zinc-700/50 text-xs font-medium text-zinc-400 mb-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
            ...
            <motion.div
              ...
              className="md:col-span-2 md:row-span-2 rounded-2xl border border-white/5 bg-gradient-to-br from-zinc-900/80 to-zinc-950/80 backdrop-blur-xl p-6 md:p-8 group hover:border-indigo-500/20 transition-all"
            >
              ...
              <h3 className="text-xl md:text-2xl font-bold text-zinc-100 mb-3">{t("features.aiInsights.title")}</h3>
              <p className="text-zinc-400 text-sm md:text-base leading-relaxed max-w-[75%]">
              ...
              <div className="mt-6 rounded-xl border border-white/5 bg-zinc-950/60 p-4">
                ...
                <div className="space-y-2">
                  <div className="flex items-start gap-2">
                    <div className="h-5 w-5 rounded-full bg-zinc-800 mt-0.5 flex items-center justify-center">
                      <span className="text-[8px] text-zinc-400">U</span>
                    </div>
                    <p className="text-xs text-zinc-300">What products are low in stock?</p>
                  </div>
                  <div className="flex items-start gap-2">
                    <div className="h-5 w-5 rounded-full bg-indigo-500/20 mt-0.5 flex items-center justify-center">
                      <Sparkles className="h-2.5 w-2.5 text-indigo-400" />
                    </div>
                    <p className="text-xs text-zinc-400">You have 12 products below threshold. Top priorities: Wireless Mouse (3 left), USB-C Hub (2 left)...</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            <motion.div
              ...
              className="rounded-2xl border border-white/5 bg-zinc-900/40 backdrop-blur-xl p-6 md:p-8 group hover:border-indigo-500/20 transition-all"
            >
              ...
              <p className="text-sm text-zinc-400 leading-relaxed">{t("features.realTime.desc")}</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg font-bold text-zinc-100 mb-2">{t("features.visualGrowth.title")}</h3>
              <p className="text-sm text-zinc-400 leading-relaxed">{t("features.visualGrowth.desc")}</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg font-bold text-zinc-100 mb-2">{t("features.inventory.title")}</h3>
              <p className="text-sm text-zinc-400 leading-relaxed">{t("features.inventory.desc")}</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg font-bold text-zinc-100 mb-2">{t("features.multiCurrency.title")}</h3>
              <p className="text-sm text-zinc-400 leading-relaxed">{t("features.multiCurrency.desc")}</p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-lg font-bold text-zinc-100 mb-2">{t("features.team.title")}</h3>
              <p className="text-sm text-zinc-400 leading-relaxed">{t("features.team.desc")}</p>
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <FadeInUp>
            <div className="max-w-4xl mx-auto">
              <div className="relative rounded-2xl border border-white/5 bg-gradient-to-br from-zinc-900/80 to-zinc-950/80 backdrop-blur-xl p-8 md:p-12">
                ...
                <blockquote className="text-lg md:text-xl text-zinc-300 leading-relaxed mb-8 max-w-[85%]">
                  {t("testimonial.quote")}
                </blockquote>
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <div className="font-semibold text-zinc-100">{t("testimonial.name")}</div>
                    <div className="text-sm text-zinc-500">{t("testimonial.role")}</div>
                  </div>
                </div>
              </div>
            </div>
      ...
      <FadeInUp>
        <section className="relative z-10 py-20 md:py-32">
          <div className="max-w-7xl mx-auto px-6">
            <div className="relative rounded-3xl border border-white/5 bg-gradient-to-br from-indigo-600/10 via-zinc-900/60 to-purple-600/10 backdrop-blur-xl p-10 md:p-16 text-center overflow-hidden">
              {/* Background orbs */}
              ...
              <div className="relative z-10">
                <h2 className="text-3xl md:text-5xl font-bold tracking-tight text-zinc-100 mb-4 max-w-3xl mx-auto">
                  {t("cta.title")}
                </h2>
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                  ...
                  <Link
                    href="/login"
                    className="inline-flex items-center gap-2 text-zinc-400 hover:text-zinc-100 px-8 py-4 rounded-full font-medium text-lg border border-zinc-800 hover:border-zinc-700 transition-all"
                  >
                    {t("buttons.liveDemo")}
                  </Link>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 md:py-20">
          <div className="grid grid-cols-2 md:grid-cols-6 gap-10 md:gap-8">
            ...
            <div className="col-span-2">
              <Link href="/" className="flex items-center gap-2 text-lg font-bold text-zinc-100 mb-4">
                <Activity className="h-5 w-5 text-indigo-400" />
                <span>SalesPulse</span>
              </Link>
              ...
              <div className="flex items-center gap-3">
                {[Globe, MessageCircle, ExternalLink, Mail].map((Icon, i) => (
                  <Link
                    key={i}
                    href="#"
                    className="h-8 w-8 rounded-lg bg-zinc-900 border border-zinc-800 flex items-center justify-center text-zinc-500 hover:text-zinc-300 hover:border-zinc-700 transition-all"
                  >
            ...
            {footerSections.map((section) => (
              <div key={section.titleKey}>
                <h4 className="text-xs uppercase tracking-[0.12em] text-zinc-500 font-medium mb-4">
